...
#define GENERATION_DELAY_SECONDS 0.01f
#define MAX_GENERATION_DELAY_SECONDS 0.005f;
#define MIN_GENERATOIN_DELAY_SECONDS 0.1f;
#define GENERATION_DELAY_STEP_SECONDS 0.005f;
